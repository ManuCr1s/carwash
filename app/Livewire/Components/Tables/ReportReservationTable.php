...
class ReportReservationTable extends LivewireTable
{
    ...
    protected function columns(): array{
        return [
            ...
            ViewColumn::make('Acciones','components.table-report-action'),
        ];
    }
    /*public function render()
    {
        return view('livewire.components.tables.report-reservation-table');
    }*/
}
